...
class UVMUser(AbstractBaseUser):
    ...
    facebook_url = models.CharField(max_length=100, required=False, null=True)
    additional_email_1 = models.CharField(max_length=100, required=False, null=True)
    additional_email_2 = models.CharField(max_length=100, required=False, null=True)
    phone_number = models.CharField(max_length=14, required=False, null=True)
